...
// correction live on every boot, whichever app runs. -EAGAIN (bootconfig probe order) or an
// unset/invalid cal -> skip silently; cellsyncd re-seeds and corrects later.
static void rfnm_si5510_apply_persisted_dco(struct i2c_client *client) {
...
repeat_search:
	...
	rfnm_si5510_apply_persisted_dco(client);
